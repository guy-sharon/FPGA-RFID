...
#
# Script generated by Vivado on Sat Nov 23 17:13:29 +0200 2024
...
# script info
echo -e "xadc_wiz_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xadc_wiz_0 -o xadc_wiz_0_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key xadc_wiz_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xadc_wiz_0_simv.daidir vcs_lib c.obj)
